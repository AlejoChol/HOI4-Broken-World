...
- States's stats need to be fully randomized
    ...
    - determined by available resources? small amounts sprinkled all over + a set amount of big resource increase that also add industry
...
- overwrite/replace_path for now-broken ai and general scripts that no longer apply to a random world
## Submods
- startdates add more nations to play with
- puppets have flavours (ssrs, colonies)
- re-add extra policies submod (gfx/interface/idea_categories.dds)
- re-add national ideas submod
